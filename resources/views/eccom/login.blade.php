...
<p class="outer-link">Don't have an account? <a href="{{ route("register.index") }}">Register here </a>
</p>
<p class="outer-link">Do You  Want Logout? <a href="{{ route("login.create") }}">Logout here </a>
</p>
</div>
</form>
</div>

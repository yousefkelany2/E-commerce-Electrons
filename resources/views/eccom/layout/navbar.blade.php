...
<link rel="shortcut icon" type="image/x-icon" href="{{asset('ecom')}}/images/favicon.svg" />

<link rel="stylesheet" href="{{asset('ecom')}}/css/bootstrap.min.css" />
<link rel="stylesheet" href="{{asset('ecom')}}/css/LineIcons.3.0.css" />
<link rel="stylesheet" href="{{asset('ecom')}}/css/tiny-slider.css" />
<link rel="stylesheet" href="{{asset('ecom')}}/css/glightbox.min.css" />
<link rel="stylesheet" href="{{asset('ecom')}}/css/main.css" />
</head>
<body>
<!--[if lte IE 9]>
...
<header class="header navbar-area">
    ...
    <div class="topbar">
        ...
        <li><a href="{{ route("eccom.index") }}">Home</a></li>
...
<a class="navbar-brand" href="{{ route("eccom.index") }}">
<img src="{{asset('ecom')}}/images/logo/logo.svg" alt="Logo">
</a>
...
<form action="{{ route("cart.destroy",$product->id) }}"  method="post" >
    @csrf
    @method("DELETE")
    <button type="submit" class="remove" title="Remove this item"><i class="lni lni-close"></i></button>
</form>
<div class="cart-img-head">
<a class="cart-img" href="{{ route('eccom.show', ['productId' => $product->id, 'categoryId' => $product->category_id ]) }}"><img src="{{ asset("storage/images/". $images[0]) }}" alt="#"></a>
</div>
<div class="content">
<h4><a href={{ route('eccom.show', ['productId' => $product->id, 'categoryId' => $product->category_id ]) }}>
{{ $product->name }}</a></h4>
<p class="quantity">{{ $cart->count }}x - <span class="amount">${{$sum_one_item  }}</span></p>
</div>
</li>
@php
     $sum+=  $sum_one_item;
...
<li class="nav-item">
<a href="{{ route("eccom.index") }}" class="active" aria-label="Toggle navigation">Home</a>
</li>
<li class="nav-item">
